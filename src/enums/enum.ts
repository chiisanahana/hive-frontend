...
export enum Notif {
    ...
    RENT_APPROVE_MSG = 'Permintaan sewa untuk mobil {car} di {city} telah disetujui. Nikmati perjalananmu!',
    ...
    PAYMENT_COMPLETE_MSG = 'Pembayaranmu untuk sewa mobil {car} pada {date} telah diterima.',
